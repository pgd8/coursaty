    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              DrawerItem(icon: AssetsManager.myCoursesIcon, title: 'My Courses'),
            ],
          ),
        ),
      ),
...
You’ll start with Flutter fundamentals — understanding widgets, layouts, and app architecture — and progress to building real-world projects with state management, navigation, animations, and backend integration. By the end of the course, you’ll be able to create fully functional, production-ready Flutter applications and understand best practices for performance optimization and app deployment."""
            ...
            CourseCard(
              course: CourseModel(
                ...
                duration: '5 months',
                price: '10000',
                description: """This course teaches how to build scalable and secure backend systems using Node.js and modern backend technologies. You will learn how to create RESTful APIs, manage databases, implement authentication, and handle real-world server-side logic.
